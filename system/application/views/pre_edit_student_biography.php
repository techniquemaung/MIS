		<?php 
/*					$s_valid_id3 = $this->uri->segment(3);
					$s_valid_id4 = $this->uri->segment(4);
					if ($s_valid_id3 !="" && is_int($s_valid_id3)){
						$this->db->select('*');
						$this->db->from('student_personal_tbl');
						$this->db->where('s_id',$s_valid_id3);
						$query = $this->db->get(); 
					}
					elseif ($s_valid_id4 !="" && is_string($s_valid_id3)){
						$this->db->select('*');
						$this->db->from('student_personal_tbl');
		...
		<div class="span-14 subtable_title push-6 prepend-top"><h5 style="color:#2b7108;">ေက်ာင္းသားမ်ားကုိယ္ေရးရာဇဝင္ျဖည့္ရန္</h5></div><br/><br/><br/>
					<div class="prepend-top" >
						<div class="span-8 last push-5 ">
							<?php echo form_open_multipart('_student/pre_edit_student_biography_process');?>
							<input type="hidden"  name="student_id"  value="<?php echo $s_valid_id3;?>">
						...
						<div span="span-8 ">
								...
								<div span="span-5 last" style="margin-top:-20px;text-align:left;margin-left:80px;">
									<input type="text" id="cname" name="student_sno"  value="<?php echo $row1->s_serial_no;?>" class="field1" width="150px;" required data-errormessage-value-missing="á€¡á€™á€½á€�á€¹á€…á€¥á€¹ á€›á€¯á€­á€€á€¹á€‘á€Šá€¹á€·á€•á€«" />
								</div>
							...
							<div span="span-8">
								...
								<div span="span-5 last" style="margin-top:-20px;text-align:left;margin-left:80px;">
									<input type="text" id="cname" name="student_name"  value="<?php echo $row1->s_name;?>" class="field1" width="150px;" required data-errormessage-value-missing="á€¡á€™á€Šá€¹ á€›á€¯á€­á€€á€¹á€‘á€Šá€¹á€·á€•á€«" />
								</div>
