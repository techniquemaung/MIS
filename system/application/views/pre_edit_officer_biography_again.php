		...
		<div class="span-14 subtable_title push-6 prepend-top"><h5 style="color:#2b7108;">ဝန္ထမ္းမ်ားကုိယ္ေရးရာဇဝင္ျဖည့္ရန္</h5></div><br/><br/>
					<div class="prepend-top" >
						<div class="span-8 last push-5 ">
							<?php echo form_open_multipart('off_biography/pre_edit_officer_biography_process_again');?>
							...
							<div span="span-8 ">
								...
								<div span="span-5 last" style="margin-top:-20px;text-align:left;margin-left:80px;">
									<input type="text"  name="teacher_sno" class="field1"  value="<?php echo $row1->t_serial_no;?>" width="150px;" required data-errormessage-value-missing="á€¡á€™á€½á€�á€¹á€…á€¥á€¹ á€›á€¯á€­á€€á€¹á€‘á€Šá€¹á€·á€•á€«" />
								</div>
							...
							<div span="span-8">
								...
								<div span="span-5 last" style="margin-top:-20px;text-align:left;margin-left:80px;">
								<input type="text"  name="teacher_name" class="field1"  value="<?php echo $row1->t_name;?>" width="150px;" required data-errormessage-value-missing="á€¡á€™á€Šá€¹ á€›á€¯á€­á€€á€¹á€‘á€Šá€¹á€·á€•á€«" /></div>
							...
							<div span="span-8" style="margin-left:130px;">
								<input class="save_btn" type="submit" value="" > </div>
							<?php 
								endforeach;
								form_close();
							?>
