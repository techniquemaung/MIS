...
border-right:1px solid #2b410c;
			...
			<div class="span-18 last">					
				<div id="vertical_container">
					<div class="span-14">
						<h3 style="color:#2b7108;font-weight:bold;margin-left:145px;">ပညာေရးဝန္ႀကီးဌာန</h3><span style="font-size:14px;color:#705a01;font-weight:bold;margin-left:145px;">ေန႔စဥ္စာ၀င္ျပဇယား</span>
					</div><br/>
				<!-- Search form start -->
				<div class="span-16 push-1 prepend-top">
