				<div class="span-18 last right_panel">
					...
					<div class="span-14 subtable_title"><h5 style="color:#2b7108;margin-left:145px;">ျပည္တြင္းပါရဂူဘြဲ႔ရ နည္းျပ/ သရုပ္ျပစာရင္း</h5></div><br/>
					<!--
					<div class="span-5">
						<form>
							<div class="span-2">
								<a href="clickaddbtn_phddemonstratorlist.htm"><input type="submit" name="add" value="Add"></a>
							</div>
							<div class="span-2">
								<a href="demonstrator_transfer.htm"><input type="submit" name="save" value="Transfer" ></a>
							</div>
						</form>
					</div>
					<hr class="space">
