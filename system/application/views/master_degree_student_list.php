				<div class="span-18 last right_panel">
					...
					<div class="span-14 subtable_title"><h5 style="color:#2b7108;margin-left:145px;">မဟာအရည္အခ်င္းစစ္ ေက်ာင္းသားစာရင္း</h5></div><br/>
					...
					<?php echo $this->multi_function->myanmar_number($row2->c_gender); ?></td>	
						...
						<?php echo $this->multi_function->myanmar_number($row3->c_gender); ?></td>	
							<td>
						<?php $total= $row3->c_gender+$row2->c_gender; 
						echo $this->multi_function->myanmar_number($total);
						echo "";		}	?>
