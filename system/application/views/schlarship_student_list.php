...
border-right:1px solid #2b410c;
			...
			<div class="span-18 last right_panel">					
					<div class="span-14 subtable_title">
						<h5 style="color:#2b7108;margin-left:145px;">ပညာသင္ဆုရေက်ာင္းသားစာရင္း</h5>
					</div><br/>
				<!-- Search form start -->
				<div class="span-16 push-7">
					<form name='search' action=<?php echo site_url('std_scholarship/schlarship_student_list/');?> method='post'>	
