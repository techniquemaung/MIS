		...
		<div class="span-18 last right_panel">
			...
			<div class="span-14 subtable_title"><h5 style="color:#2b7108;margin-left:145px;">ဝန္ထမ္းမ်ား၏ ရာထူးမ်ား</h5></div><br/>
				...
				<?php echo form_open_multipart('position/position_edit_process');?>		
			<input type="hidden" name="hidden_uid" id="hidden_uid" value=" <?php echo $u_id ?>"  class="field1" />
			<input type="hidden" name="hidden_position" value=" <?php echo $position_id ?>"  class="field1" />
			</div><hr class="space">			
			<div class="span-20">			
				<div class="span-20">
					<div class="span-12 field1_text">
						<div class="span-14 push-1 field1_text">				
							<div class="span-8">ရာထူး (အမည္)</div>
								<div class="span-4"><input type="text" name="position_name" value="<?php echo $position_name;?>" class="field1" required data-errormessage-value-missing="စာအမွတ္ မွန္ကန္စြာရုိက္ထည့္ပါ"  /></div>
							...
							<div class="span-4"><input type="text" name="position_count" value="<?php echo $position_count;?>" class="field1" required data-errormessage-value-missing="အေၾကာင္းအရာ မွန္ကန္စြာရုိက္ထည့္ပါ"  /></div>
